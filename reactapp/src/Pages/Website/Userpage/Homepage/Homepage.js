    ...
    return(
        <div className={classes.main}>
            ...
            <div className={classes.lines}>
                <div className={classes.img2}>Unlock the door to your new beginning.</div>
                <div className={classes.img3}>Discover the joy of homeownership.</div>
                <div className={classes.img4}>Your perfect home is waiting to embrace you.</div>
            </div>
            ...
            <div className={classes.r}>
                <div className={classes.r1}>
                    ...
                    <div className={classes.text}>Explore a diverse range of properties for sale or rent. Find your dream home,
                                                    whether it's a cozy apartment, a spacious family house, or an elegant luxury property.
                                                    Discover the perfect property that matches your preferences and budget in desirable locations. </div>
                </div>
                <div className={classes.r2}>
                    <img src={r2} alt=""/>
                    <div className={classes.heading}>User-friendly interface</div>
                    <div className={classes.text}>Effortlessly navigate through our extensive property listings. Find your ideal home or investment opportunity with ease. Explore and discover properties that match your preferences and requirements.</div>
                </div>
                <div className={classes.r3}>
                    <img src={r3} alt=""/>
                    <div className={classes.heading}>Expert Agents</div>
                    <div className={classes.text}>Connect with experienced real estate agents for personalized assistance. Our team of professionals is here to guide you through the buying or renting process. Benefit from their expertise and make informed decisions with their support.</div>
                </div>
            </div>
